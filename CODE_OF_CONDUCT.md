...
Causly Server project a harassment-free experience for everyone, regardless
...
reported to the project maintainer at **nihal@causly.in**. All complaints
...
1. **Correction** — A private, written warning for a single minor incident.
2. **Warning** — A warning with consequences for continued behavior,
   including a temporary ban from interaction.
3. **Temporary Ban** — A temporary ban from any interaction with the
   project for a specified period.
4. **Permanent Ban** — A permanent ban from any public interaction with
   the project.
